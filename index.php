  ...
  <body>
    ...
    <header>
      <div class="header-top">
        <a class="logo" href="#"><img src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_74x24dp.png" alt=""></a>
    ...
    <main>
      ...
      <div class="container-faq">
        <?php foreach ($faq as $k1 => $value1) { ?>
          <?php foreach ($value1 as $value2) { ?>

              <h2><?php echo($value2['q']); ?></h2>
              <div><?php echo($value2['a']); ?><div>
